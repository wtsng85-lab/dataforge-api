...
from app.models import EmailValidateRequest
from app.validators.email import validate_email

router = APIRouter(prefix="/email", tags=["Email"])


@router.get("/validate", summary="Validate an email address")
...
@router.post("/validate", summary="Validate an email address (POST)")
